/**
 * Test script: Create invoice from VNPay payment with deposit
 * 
 * This script simulates VNPay payment flow with deposit:
 * 1. Mock a VNPay payment with recordId and depositAmount
...
async function testVNPayInvoiceCreation() {
  try {
    console.log('🟢 Starting VNPay Invoice Creation Test...\n');
    ...
    // Mock VNPay payment (giống real case từ payment-service)
    const mockPayment = {
      _id: new mongoose.Types.ObjectId(),
      paymentCode: 'VNPAY-TEST-001',
      ...
      paidAmount: 1800000,      // 🔥 Số tiền khách trả qua VNPay
      amount: 1800000,
      paymentMethod: 'vnpay',
      externalTransactionId: 'VNPAY20251129001',
      ...
      gatewayResponse: {
        ...
        transactionId: 'VNPAY20251129001'
      }
    };
    ...
    console.log('💳 Mock VNPay Payment:', {
      ...
      paidAmount: mockPayment.paidAmount.toLocaleString('vi-VN') + ' VNĐ (Paid via VNPay)',
    ...
    console.log('📝 Creating invoice from VNPay payment...\n');
